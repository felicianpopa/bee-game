...
export default function hiveUI(swarmData: SwarmData): void {
  const hiveContainer = document.getElementById("hive") as HTMLDivElement;
  hiveContainer.innerHTML = "";

  function createBeeTypeElement(key: string): HTMLDivElement {
  ...
  function createBeeElement(health: number): HTMLDivElement {
